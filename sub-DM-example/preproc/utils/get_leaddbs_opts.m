...
function options=get_leaddbs_opts()
options.patientname='sub-DM1008'; %add patientname
...
%%
options.dolc = 0;
options.uipatdirs = {'Y:\DBS\derivatives\sub-DM1012'}; %change directory
...
options.root = 'Y:\DBS\derivatives\' %add root;
